    ...
    <script>
      ...
      app.controller('TopnavCtrl', function($scope, $rootScope, $http, $timeout, $filter) {
        ...
        if (LoginData.UserType.Id == 3) {
          ...
          $rootScope.ProfileUrl = LoginData.Customer.CustomerProfileUrl;
        } else {
    ...
    function sideBarStart()
    {
      ...
      function sidBar_Brand()
      {
        ?>
          <div class="app-brand demo">
            <a href="CustomerDashboard" class="app-brand-link">
      ...
      function SidebarListStart()
      {
        ...
        function Dashboard()
        {
          ?>
            <!-- Dashboard -->
            <li class="menu-item " ng-If="UserTypeID==3">
              <a href="<?php print $_SESSION["DocRoot"]; ?>CustomerDashboard" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Dashboard</div>
              </a>
            </li>
            <li class="menu-item " ng-If="UserTypeID==4">
              <a href="<?php print $_SESSION["DocRoot"]; ?>UserDashboard" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Dashboard</div>
              </a>
            </li>
          ...
          ?>
            ...
            <li class="menu-item " ng-if="UserTypeID==3">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="Without menu">Tickets</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/1" class="menu-link">
                    <div data-i18n="Without menu">New Development </div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/2" class="menu-link">
                    <div data-i18n="Without navbar">Service</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/3" class="menu-link">
                    <div data-i18n="Container">Bug Fix</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/4" class="menu-link">
            ...
            <li class="menu-item" ng-if="UserTypeID==4">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>UserTicket/1" class="menu-link">
                    <div data-i18n="Without menu">New Development </div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>UserTicket/2" class="menu-link">
                    <div data-i18n="Without navbar">Service</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>UserTicket/3" class="menu-link">
                    <div data-i18n="Container">Bug Fix</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php print $_SESSION["DocRoot"]; ?>UserTicket/4" class="menu-link">
                    <div data-i18n="Fluid">Update</div>
                  </a>
                </li>
              </ul>
            ...
            <li class="menu-item" ng-if="UserTypeID==3">
              <a href="<?php print $_SESSION["DocRoot"]; ?>User" class="menu-link">
        ...
        function sidebar_Component()
        {
          ?>
            <!-- Components -->
            <li class="menu-item" ng-if="UserTypeID==3">
              <a href="<?php print $_SESSION["DocRoot"]; ?>MyProducts" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Products</div>
              </a>
            </li>
            <li class="menu-item" ng-if="UserTypeID==3">
              <a href="<?php print $_SESSION["DocRoot"]; ?>MyServices" class="menu-link">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Boxicons">Services</div>
              </a>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img ng-src="{{ ProfileUrl ? GetProfileUrl(ProfileUrl) : '../assets/img/avatars/8.png' }}" alt="Profile Image" class=" w-px-40 h-auto rounded-circle" />
                      <!-- <img ng-show="ProfileUrl == null" src="assets/img/avatars/8.png" alt="Profile Image" class="w-px-40 h-auto rounded-circle" /> -->
                    </div>
                  </a>
                  <?php
                  // }
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{CustomerName}}</span>
                    ...
                    ?>
                    <li>
                      <a class="dropdown-item" href="<?php print $_SESSION["DocRoot"]; ?>MyProfile">
                ...
                <div class="modal fade" id="<?php echo $ModalId; ?>" tabindex="-1" aria-hidden="true">
                  <div class="modal-dialog modal-<?php echo $ModelSize; ?>" role="document">
                    <div class="modal-content">
                      ...
                      <form id="<?php echo $FormId; ?>" autocomplete="off" ng-controller="<?php echo $Controller; ?>" ng-model="<?php echo $FormModel; ?>" ng-submit="<?php echo $SubmitFunction; ?>">
                        ...
                        <?php
                        function ModalEnd($BtnStatus, $Btn1title, $BtnId)
                        {
                        ?>
                        </div>
                        <div class="modal-footer">
                          ...
                          <button type="submit" class="btn btn-primary" id="<?php echo $BtnId ?>" ng-click="" ng-show="<?php echo $BtnStatus; ?>"><?php echo $Btn1title; ?></button>
                        </div>
                      </form>
                    </div>
                  </div>
