    ...
    <form action="" ng-controller="DashBoardCtrl">
        ...
        <div class="col-lg-12 order-1">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/spreadsheet-regular-72.png" alt="Product" class="rounded" />
                                </div>
                            </div>
                            <span class="fw-semibold d-block mb-1">Total Products</span>
                            <h5 class="card-title mb-2">
                                <a href="">
                                    <span style="cursor: pointer;" class="badge badge-center rounded-pill bg-success" ng-click="showProduct(1)" title="Active Product">{{ActiveProduct}}</span>
                                </a>
                                <span>&nbsp;|&nbsp;</span>
                                <a href="">
                                    <span style="cursor: pointer;" class="badge badge-center rounded-pill  bg-danger" ng-click="showProduct(0)" title="Deactive Product">{{DeactiveProduct}}</span>
                                </a>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/1?status=1" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/envelope-regular-72.png" alt="Ticket" class="rounded" />
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/1?status=1" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/file-import-solid-72.png" alt=" Raised Tickets" class="rounded" />
                                    </div>
                                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/1?status=2" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/briefcase-solid-72.png" alt="Process Tickets" class="rounded" />
                                    </div>
                                </div>
        ...
        <div class="col-lg-12 order-1">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/1?status=3" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/support-regular-72.png" alt="Query-Response" class="rounded" />
                                    </div>
                                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Ticketlist/1?status=4" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/calendar-check-solid-72.png" alt="Closed Tickets" class="rounded" />
                                    </div>
                                </div>
...
<script>
    ...
    app.controller('DashBoardCtrl', function($scope, $rootScope, $http, $timeout, $filter) {
        ...
        $scope.GetProductsCounts = function() {
            var url = APIRootPath + "api/items/get_ProductCounts/" +$rootScope.UserUUID +"/" + $rootScope.LinkedToId +"/" + $rootScope.UserTypeId;
        ...
        $scope.GetTicketCounts = function(){
            var url = APIRootPath + "api/tickets/getTIcketCounts/"+$rootScope.UserUUID +"/" + $rootScope.LinkedToId +"/" + $rootScope.UserTypeId;
            $http.get(url,urlconfig).then(
                function(response){
                    ...
                    $scope.RaisedCount = parseFloat($scope.RaisedCount) +  parseInt($scope.AssignedCount);
                },
                function(response){
                    if (response.data.status != 401) {
                        Swal.fire("OOPS", response.data.message, "error");
        ...
        $scope.GetTickets = function() {
            var url = APIRootPath + "api/tickets/get_TicketForSearch/" + $rootScope.UserUUID +"/" + $rootScope.LinkedToId +"/" + $rootScope.UserTypeId;
            $http.get(url, urlconfig).then(
                function(response) {
