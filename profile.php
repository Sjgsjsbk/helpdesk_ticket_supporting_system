...
<div class="row">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a class="fw-bold" href="Dashboard" style="padding-bottom: 10px;"><button type="button" class="btn btn-dark">Back</button></a>
    </div>
</div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
                ...
                <!-- <img ng-show="ProfileUrl == 0" src="assets/img/avatars/8.png" alt="user-avatar" class="d-block rounded" height="auto" width="100" id="uploadedAvatar" /> -->
