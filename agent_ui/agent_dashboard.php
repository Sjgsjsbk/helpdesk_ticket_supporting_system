        ...
        <div class="col-lg-12 order-1">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>AgentTickets/1?status=1" class="menu-link">
                            <div class="card-body">
                                ...
                                <span class="fw-semibold d-block mb-1">Total Assigned Tickets</span>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>AgentTickets/1?status=2" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>AgentTickets/1?status=3" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>AgentTickets/1?status=4" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
...
ModalStart("GotoTicketModal", "dialog-scrollable modal-xl", "Ticket", "FrmGotoTicket", "FrmGotoTicket", "FrmGotoTicketCtrl", "")
?>
    ...
    <table class="table">
        ...
        <tbody class="table-border-bottom-0">
            <tr ng-repeat="Ticket in FillterTicketList | orderBy:['-PriorityId','-RaisedOn'] | filter:FillterText">
                ...
                <td>
                    <a href="<?php print $_SESSION['DocRoot']; ?>AgentTickets/{{Ticket.TicketCategoryId}}?Code={{Ticket.Code}}&status={{Ticket.StatusId}}" title="Details">
...
<script>
    ...
    app.controller('DashBoardCtrl', function($scope, $rootScope, $http, $timeout, $filter) {
        ...
        $scope.GetTicketCounts = function() {
            var url = APIRootPath + "api/tickets/getTIcketCounts/" + $rootScope.UserUUID + "/" + $rootScope.AgentId + "/" + $rootScope.UserTypeId;
        ...
        {
            var url = APIRootPath + "api/tickets/get_TicketForSearch/" + $rootScope.UserUUID + "/" + $rootScope.AgentId + "/" + $rootScope.UserTypeId;
            $http.get(url, urlconfig).then(
                function(response) 
                {
