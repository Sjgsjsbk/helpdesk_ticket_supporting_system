    ...
    <div class="row">
                            ...
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/user-rectangle-solid-72.png" alt="Credit Card" class="rounded" />
                                    </div>
                                </div>
                                <span class="fw-semibold d-block mb-1" style="width: 130px;">Total Customers</span>
                                <h5 class="card-title mb-2">{{TotalCustomer}}</h5>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/spreadsheet-regular-72.png" alt="Credit Card" class="rounded" />
                                </div>
                            </div>
                            <a href="" class="menu-link">
                                <span class="fw-semibold d-block mb-1">Total Products</span>
                            </a>
                            <!-- <h5 class="card-title mb-2">{{TotalProduct}}</h5> -->
                            <a href="">
                                <span style="cursor: pointer;" class="badge badge-center rounded-pill bg-success" title="Active Product">{{ActiveProduct}}</span>
                            </a>
                            <span>&nbsp;|&nbsp;</span>
                            <a href="">
                                <span style="cursor: pointer;" class="badge badge-center rounded-pill  bg-danger" title="Deactive Product">{{DeactiveProduct}}</span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-8 col-lg-6 order-3 order-md-2">
            <div class="row">
                    ...
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Agents" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/user-circle-regular-72.png" alt="Credit Card" class="rounded" />
                                    </div>
                                </div>
                                <span class="fw-semibold d-block mb-1">Total Agents</span>
                                <h5 class="card-title text-nowrap mb-2">{{TotalAgents}}</h5>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-6 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Tickets/1?status=Raised" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="<?php print $_SESSION["DocRoot"]; ?>assets/img/icons/unicons/envelope-regular-72.png" alt="Credit Card" class="rounded" />
                                    </div>
                                </div>
                                <span class="fw-semibold d-block mb-1">Total Tickets</span>
                                <h5 class="card-title mb-2">{{TotalTicket}}</h5>
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-4 order-1">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Tickets/1?status=Processing" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                ...
                                <h5 class="card-title mb-2">{{totalProccesTicket}}</h5>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="col-lg-6 col-md-4 order-1">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Tickets/1?status=Assigned" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                ...
                                <span class="fw-semibold d-block mb-1">Assigned Tickets</span>
                                <h5 class="card-title mb-2">{{AssignedCount}}</h5>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <a href="<?php print $_SESSION["DocRoot"]; ?>Tickets/1?status=Complete" class="menu-link">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
    ...
    <table class="table">
        ...
        <tbody class="table-border-bottom-0">
            <tr ng-repeat="Ticket in FillterTicketList | orderBy:['-PriorityId','-RaisedOn'] | filter:FillterText">
                ...
                <td>
                    <a href="<?php print $_SESSION['DocRoot']; ?>Tickets/{{Ticket.TicketCategoryId}}?Code={{Ticket.Code}}&status={{Ticket.TicketStatus}}" title="Details">
...
<script>
    ...
    app.controller('DashBoardCtrl', function($scope, $rootScope, $http, $timeout, $filter) {
        ...
        $scope.ClosedCount = 0;
        $rootScope.AssignedCount = 0;

        $scope.GetCustomerCounts = function() {
            var url = APIRootPath + "api/items/getCustomerCounts/" + $rootScope.UserUUID;
            $http.get(url, urlconfig).then(
                function(response) {
                    $scope.customers = response.data.CustomerCounts[0];
                    $scope.TotalCustomer = $scope.customers.TotalCustomers;
                },
                function(response) {
        ...
        $scope.GetProductsCounts = function() {
            var url = APIRootPath + "api/items/get_ProductCounts/" + $rootScope.UserUUID;
            $http.get(url, urlconfig).then(
                function(response) {
                    $scope.ProductsCounts = response.data.ProductsCounts[0];
                    $scope.ActiveProduct = $scope.ProductsCounts.ActiveProduct;
                    $scope.DeactiveProduct = $scope.ProductsCounts.InActiveProduct;
                },
                function(response) {
                    if (response.data.status != 401) {
                        Swal.fire("OOPS", response.data.message, "error");
        ...
        $scope.GetAgentCounts = function() {
            var url = APIRootPath + "api/items/get_AgentCounts/" + $rootScope.UserUUID;
            $http.get(url, urlconfig).then(
                function(response) {
                    $scope.TotalAgents = 0;
                    $scope.TotalAgentCount = response.data.AgentCounts[0];
                    $scope.TotalAgents = $scope.TotalAgentCount.TotalAgents;
                },
                function(response) {
                    if (response.data.status != 401) {
                        Swal.fire("OOPS", response.data.message, "error");
        ...
        $scope.GetTicketCounts = function() {
            var url = APIRootPath + "api/tickets/getTIcketCounts/" + $rootScope.UserUUID;
            $http.get(url, urlconfig).then(
                function(response) {
                    ...
                    $scope.totalProccesTicket = parseFloat($scope.ProcessingCount) + parseInt($scope.QueryReopensCount);
                },
                function(response) {
                    if (response.data.status != 401) {
                        Swal.fire("OOPS", response.data.message, "error");
        ...
        $scope.GetTickets = function() {
            var url = APIRootPath + "api/tickets/get_TicketForSearch/" + $rootScope.UserUUID;
            $http.get(url, urlconfig).then(
                function(response) {
        ...
        $scope.refreshAll = function() {
            $scope.GetAgentCounts();
            $scope.GetProductsCounts();
            $scope.GetCustomerCounts();
            $scope.GetTicketCounts();
            $scope.GetTickets();
        }
